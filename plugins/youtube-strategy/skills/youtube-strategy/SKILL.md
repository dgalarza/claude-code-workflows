...
description: Invoke this skill whenever you are working on something related to YouTube. Assists in generating essential elements that drive engagement and discovery.
---
...
1. **Title + Thumbnail** make a promise that creates curiosity
2. **Hook (first 20 seconds)** must deliver on that promise immediately
...
IDEATION
  ↓
  Is the idea differentiated? (Would you spend $1,000?)
  Does it serve your audience avatar?
  ↓
PACKAGING (as one unit)
  ↓
...
POST-PRODUCTION
  ↓
  Description, Pinned Comment, Final Checks
```
